...
(function (root) {
  ...
  var CARDS_EXTRA = [
    ...
    { id:'gj25', herb:'chenxiang', src:'屈大均《广东新语》',
      quote:'东粤有四市：药市在罗浮冲虚观，香市在东莞之寮步。',
      desc:'清初屈大均记粤中四市，香市专在东莞寮步，莞香由是行天下。沉香结香需年久，价几与金等，粤海关岁入亦倚此为一大宗。' },
    { id:'gj26', herb:'tanxiang', src:'《香乘·卷九》',
      quote:'檀香出海外诸国，今岭南、滇中亦有之。',
      desc:'明末周嘉胄《香乘》为香事之总汇，记檀香多自海外而来。佛门香市所亟，焚之清芬远逸，乾隆间番舶仍载之不绝。' }
  ];
